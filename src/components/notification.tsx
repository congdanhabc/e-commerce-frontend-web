...
function Notification ({ title, description, buttonText, buttonLink, type }: NotificationProps) {
          ...
          <div className={`w-full max-w-lg ${config.bgColor} border ${config.borderColor} rounded-3xl p-10 md:p-14 text-center`}>
            <div className="space-y-6">
              ...
              <div className="flex justify-center">
                <div className={`w-16 h-16 ${config.iconColor} flex items-center justify-center`}>
